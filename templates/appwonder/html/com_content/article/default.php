...
DEFINE('DATE_FORMAT_LC233',"%m/%d/%Y");
DEFINE('DATE_FORMAT_LC23',"%A, %d %B %Y %H:%M");
...
<div class="s5_datewrapper" style="margin-right:15px;">	
		<div class="s5_daydate">
		<?php echo JHTML::_('date', $this->article->created, JText::_('DATE_FORMAT_DAY')) ?>
		</div>
		
		<div class="s5_dateswrap">
		<span class="s5_first">
		<?php
		$stripstring = JHTML::_('date', $this->article->created, JText::_('DATE_FORMAT_MONTH'));
		echo substr($stripstring, 0, 3);?>
		</span>
		<div class="s5_yeardate">
		<?php echo JHTML::_('date', $this->article->created, JText::_('DATE_FORMAT_YEAR')); ?>
		</div>
		</div>
