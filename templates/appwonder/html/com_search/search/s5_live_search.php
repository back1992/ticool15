...
<div id="s5_search_results">			
	<?php
		...
		?>
			<div class="s5_ls_top_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; border-bottom:solid 1px #<?php echo $_SESSION['bar_border_color'] ?>; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px">
		...
		?>
			<div class="s5_ls_bottom_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; border-top:solid 1px #<?php echo $_SESSION['bar_border_color'] ?>; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px">
				<a class="s5_ls_bar_a" href="<?php echo JRoute::_('index.php?option=com_search&view=search&searchphrase='.$searchphrase.'&ordering='.$ordering.'&limit=0&searchword='.$searchword); ?>">
					<span onmouseout="this.style.textDecoration='none'" onmouseover="this.style.textDecoration='underline'" class="s5_ls_bar_span" style="color:#<?php echo $_SESSION['bar_font_color'] ?>; font-size:<?php echo $_SESSION['bar_font_size'] ?>px">
						<?php echo $this->pagination->total.' '.$resultsText; ?>
					</span>
		...
		?>
			<div class="s5_ls_top_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; border-bottom:solid 1px #<?php echo $_SESSION['bar_border_color'] ?>; height:14px; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px; background-color:#<?php echo $_SESSION['bar_bg_color'] ?>">				
				<div style="height:18px; width:18px" onclick="javascript:closeResultDiv();" id="s5_ls_close"></div>
			</div>
			...
			<div class="s5_ls_bottom_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; border-top:solid 1px #<?php echo $_SESSION['bar_border_color'] ?>; height:14px; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px; background:#<?php echo $_SESSION['bar_bg_color'] ?>">				
			</div>
		<?php	
		}
	?>												
