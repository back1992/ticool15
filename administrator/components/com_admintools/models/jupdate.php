...
class AdmintoolsModelJupdate extends JModel
{
	...
	private $sqlVersions = array(
		'1.7.0'		=> '1.7.0-2011-06-06-2',
		'1.7.1'		=> '1.7.1-2011-09-20',
		'1.7.2'		=> '1.7.1-2011-09-20',
		'1.7.3'		=> '1.7.3-2011-11-10',
		'1.7.4'		=> '1.7.4-2011-12-12',
		'1.7.5'		=> '1.7.4-2011-12-12',
		'1.7.6'		=> '1.7.4-2011-12-12',
		'2.5.0'		=> '2.5.0-2012-01-14',
		'2.5.1'		=> '2.5.1-2012-01-26',
		'2.5.2'		=> '2.5.2-2012-02-03',
		'2.5.3'		=> '2.5.2-2012-02-03',
		'2.5.4'		=> '2.5.2-2012-02-03', // Wild guess
		'2.5.5'		=> '2.5.2-2012-02-03', // Wild guess
	);
...
ENDDATA;
	...
	public function checkSchemasTable()
	{
		...
		$query->select('version_id')
			->from('#__schemas')
			->where($db->nameQuote('extension_id').' = '.$db->quote(700));
		$db->setQuery($query);
