...
{
	return JError::raise(E_ERROR, 500, 'PHP '.$version.' is not supported by Admin Tools');
}
...
if(version_compare(JVERSION, '2.5', 'lt') && version_compare(JVERSION, '1.6.0', 'ge')) {
	return JError::raise(E_ERROR, 500, 'Joomla! 1.6.x/1.7.x is not supported by this version of Admin Tools. Please read our release announcement.');
}
