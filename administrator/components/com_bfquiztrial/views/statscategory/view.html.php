<?php
/**
 * Category View View for bfquiztrial Stats Component
 *
 * @package    Joomla
...
/**
 * bfquiztrialViewStatsCategory View
 *
 * @package    Joomla
 * @subpackage Components
 */
class bfquiztrialViewStatsCategory extends JView
{
    /**
    ...
    {
        JToolBarHelper::title( JText::_( 'BF Quiz Stats - Select Category' ), 'bfquiztrial_toolbar_title' );
