<?php
/**
 * Question View for bfquiztrial Component
 *
 * @package    Joomla
 ...
 * @subpackage Components
 */
class bfquiztrialViewQuestion extends JView
{
	/**
	 * display method of Question view
	 * @return void
	 **/
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'BF Quiz- Question setup' ).': <small><small>[ ' . $text.' ]</small></small>', 'bfquiztrial_toolbar_title' );
		JToolBarHelper::save();
		if ($isNew)  {
