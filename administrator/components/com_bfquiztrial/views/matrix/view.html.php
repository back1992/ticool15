<?php
/**
 * Matrix View for bfquiztrial Component
 *
 * @package    Joomla
 ...
 * @subpackage Components
 */
class bfquiztrialViewmatrix extends JView
{
	/**
	 * Matrix view display method
	 * @return void
	 **/
	function display($tpl = null)
	{
		JToolBarHelper::title(   JText::_( 'BF Quiz ABCD Answer Matrix' ), 'bfquiztrial_toolbar_title');
		...
		JToolBarHelper::customX( 'matrixanswer', 'new.png', 'new_f2.png', 'New', false, false );
