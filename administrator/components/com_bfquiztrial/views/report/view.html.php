<?php
/**
 * Report View for bfquiztrial Component
 *
 * @package    Joomla
...
/**
 * bfquiztrialViewMyRequests View
 *
 * @package    Joomla
 * @subpackage Components
 */
class bfquiztrialViewReport extends JView
{
    /**
    ...
    {
        JToolBarHelper::title( JText::_( 'BF Quiz' ), 'bfquiztrial_toolbar_title' );
