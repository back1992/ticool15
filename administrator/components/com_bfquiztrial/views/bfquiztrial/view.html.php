<?php
/**
 * Questions View for bfquiztrial Component
 *
 * @package    Joomla
 ...
 * @subpackage Components
 */
class bfquiztrialViewbfquiztrial extends JView
{
	/**
	 * bfquiztrials view display method
	 * @return void
	 **/
	function display($tpl = null)
	{
		JToolBarHelper::title(   JText::_( 'BF Quiz Question Manager' ), 'bfquiztrial_toolbar_title');
		...
		//JToolBarHelper::preferences('com_bfquiztrial',440);
