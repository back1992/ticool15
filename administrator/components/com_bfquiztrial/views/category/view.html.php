<?php
/**
 * Category View View for bfquiztrial Component
 *
 * @package    Joomla
...
/**
 * bfquiztrialViewCategory View
 *
 * @package    Joomla
 * @subpackage Components
 */
class bfquiztrialViewCategory extends JView
{
    /**
    ...
    {
		JToolBarHelper::title( JText::_( 'BF Quiz - Select Category for reporting' ), 'bfquiztrial_toolbar_title' );
