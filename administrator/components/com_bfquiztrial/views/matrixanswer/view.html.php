<?php
/**
 * MatrixAnswer View for bfquiztrial Component
 *
 * @package    Joomla
 ...
 * @subpackage Components
 */
class bfquiztrialViewMatrixAnswer extends JView
{
	/**
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'BF Quiz- ABCD Answer Matrix' ).': <small><small>[ ' . $text.' ]</small></small>', 'bfquiztrial_toolbar_title' );
		JToolBarHelper::save('savematrix','Save');
		if ($isNew)  {
