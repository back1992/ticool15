...
<div id="editcell">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$link 		= JRoute::_( 'index.php?option=com_bfquiztrial&controller=scorerange&task=scorerangeanswer&cid[]='. $row->id );
...
<input type="hidden" name="task" value="scorerange" />
<input type="hidden" name="boxchecked" value="0" />
<input type="hidden" name="filter_order" value="<?php echo $lists['order']; ?>" />
<input type="hidden" name="filter_order_Dir" value="<?php echo $lists['order_Dir']; ?>" />
<input type="hidden" name="controller" value="scorerange" />
<input type="hidden" name="c" value="scorerange" />
<input type='hidden' name='view' value='scorerange' />
