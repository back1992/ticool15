 ...
 * @subpackage Components
 */
class bfquiztrialControllerscorerangeAnswer extends JController
{
	/**
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_bfquiztrial&controller=scorerange&task=scorerange', $msg );
	}
	...
	function savescorerange()
	{
		...
		$link = 'index.php?option=com_bfquiztrial&controller=scorerange&task=scorerange';
